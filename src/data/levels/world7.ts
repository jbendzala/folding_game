...
export const world7Levels: LevelDefinition[] = [
  ...
  shapeLevel({
    ...
    goalRows: ['# # . # #', '. # # # .', '# # . # #'],
    newConcept: 'Fold both wingtips in -- the body and the gaps between wings stay untouched.',
    difficulty: 9,
    expectedFolds: 2,
    designerNotes: 'Two folds, 75% trap. The gaps make it: patch one by accident and it is lost.',
  }),
  shapeLevel({
    id: 33,
    name: 'Iron Cross',
